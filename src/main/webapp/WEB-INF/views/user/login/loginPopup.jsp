...
function findId(){
    opener.location.href="${app}/findIdNameEmail";
    self.close();
}

function signUp(){
	opener.location.href="${app}/signUp/signUpStart";
	self.close();
}
...
<div class="popup-win wp-log-hmall">
    <div class="pop-wrap" tabindex="0">
        <div class="pop-content-wrap">
            <strong class="pop-title">Hmall & Share 로그인</strong>
                ...
                <div class="tabgroup bdline">
                    ...
                    <div role="tabpanel" class="tab-pane ui-active" id="hmallLogin">
                                ...
                                <ul class="login-find">
                                    ...
                                    <li><a href="javascript:;" onclick="signUp()">회원가입</a></li>
                                </ul>
